...
HD_PWD='F:/GitHub/XILINX_BASYS_3/XILINX_BASYS_3.runs/CPU_1_rst_clk_wiz_1_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_1_rst_clk_wiz_1_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_1_rst_clk_wiz_1_100M_0.tcl
