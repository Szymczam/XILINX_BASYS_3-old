...
HD_PWD='F:/GitKraken/XILINX_BASYS_3/XILINX_BASYS_3.runs/CPU_1_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_1_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_1_xbar_0.tcl
