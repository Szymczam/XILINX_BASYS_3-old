...
HD_PWD='F:/GitHub/XILINX_BASYS_3/XILINX_BASYS_3.runs/CPU_1_clk_wiz_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_1_clk_wiz_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_1_clk_wiz_0_1.tcl
